# 68c89608-446e-4cf6-a173-d0d1729f7ec3 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `line-64-design-system-2.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `line-64-design-system-2.html`
...
- A single self-contained `line-64-design-system-2.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `line-64-design-system-2.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
1. Inspect `line-64-design-system-2.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
